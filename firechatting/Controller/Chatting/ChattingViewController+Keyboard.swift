        ...
        UIView.animate(
            ...
            animations: {
                if isShowing{
                    ...
                    self.tblChatList.frame.size.height = self.view.bounds.size.height - self.chatActionBarView.frame.size.height - heightOffset - 64
                ...
                else
                {
                    ...
                    self.tblChatList.frame.size.height =  self.view.bounds.size.height - self.chatActionBarView.frame.size.height -  64
                }
            },
            completion: { bool in
                if isShowing{
